...
function writeInitialInstructions(
  ...
  let scriptContents = `(self.__next_f=self.__next_f||[]).push(${htmlEscapeJsonString(
    getTracer().trace(AppRenderSpan.jsonStringifyBootstrap, () =>
  ...
  if (formState != null) {
    scriptContents += `;self.__next_f.push(${htmlEscapeJsonString(
      getTracer().trace(AppRenderSpan.jsonStringifyFormState, () =>
...
function writeFlightDataInstruction(
  ...
  if (typeof chunk === 'string') {
    htmlInlinedData = htmlEscapeJsonString(
      getTracer().trace(AppRenderSpan.jsonStringifyData, () =>
    ...
    const base64 =
      typeof Buffer !== 'undefined'
        ? getTracer().trace(AppRenderSpan.bufferFromBase64, () =>
            Buffer.from(
              chunk.buffer,
              chunk.byteOffset,
              chunk.byteLength
    ...
    htmlInlinedData = htmlEscapeJsonString(
      getTracer().trace(AppRenderSpan.jsonStringifyBinary, () =>
